#!/usr/bin/env python3
"""Preflight by default; explicitly apply governed v3 development only after merge."""
...
from flight_delay.modeling.v3.execution import preflight, run_development_apply
