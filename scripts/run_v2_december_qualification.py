#!/usr/bin/env python3
"""Preflight by default; explicitly qualify the frozen v2 winner on December once."""
...
from flight_delay.modeling.v2.execution import preflight, run_december_apply
