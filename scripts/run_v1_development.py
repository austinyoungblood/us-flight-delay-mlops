#!/usr/bin/env python3
"""Preflight by default; explicitly apply the one-time governed v1 development run."""
...
from flight_delay.modeling.v1_execution import preflight, run_development_apply


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument("--apply", action="store_true", help="run the governed experiment once")
    parser.add_argument(
