"""Dependency-inverted, lazy W&B tracking for governed v3 execution."""
...
class WandbTracker:
    def __init__(self, *, entity: str, project: str) -> None:
        if not entity or not project:
            raise ValueError("online v3 tracking requires W&B entity and project")
        self.entity = entity
    ...
    def start_run(self, *, name: str, group: str, metadata: dict[str, Any]) -> Any:
        ...
        return wandb.init(
            ...
            name=name,
            group=group,
            job_type="governed-v3-experiment",
            config=metadata,
            mode="online",
        )
